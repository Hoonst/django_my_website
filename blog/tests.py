...
class TestView(TestCase):
    ...
    def test_post_list(self):
        ...
        self.assertIn('아직 게시물이 없다!', soup.body.text)
        ...
        self.assertNotIn('아직 게시물이 없다!', body.text)
        self.assertIn(post_000.content, body.text)
    ...
    def test_post_detail(self):
        ...
        self.assertIn(post_000.content, main_div)
